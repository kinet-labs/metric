...
Prometheus metrics helpers: standard counters, gauges, histograms, and instrumentation conventions for all components.
...
```bash
go get github.com/kinet-labs/metric@latest
```
...
import (
    "net/http"
    metrics "github.com/kinet-labs/metric"
)
