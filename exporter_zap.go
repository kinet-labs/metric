...
//
// Metric families serialize to JSON inside a kinet-labs/zap envelope and ship
...
//
// Mirrors kinet-labs/trace/exporter_zap.go (MsgSpanBatch=1). The two
...
// with kinet-labs/trace.MsgSpanBatch (=1); collectors switch on the
...
// ZAPExporter ships metric families over a kinet-labs/zap connection.
//
...
// same convention kinet-labs/trace uses for MsgSpanBatch.
